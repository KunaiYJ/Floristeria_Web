...
class AuthController {
    ...
    public static function registro(Router $router) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (empty($alertas)) {
                ...
                if ($existeUsuario) {
                    ...
                    // Asignar rol predeterminado (por ejemplo, 3 para cliente)
                    $usuario->IDrol = 3;
                    ...
                    if ($resultado['resultado']) {
                        ...
                        Usuario::setAlerta('error', 'Error al guardar el usuario.');
                        $alertas = Usuario::getAlertas();
                    }
                }
            }
        ...
        $router->render('auth/registro', [
            'titulo' => 'Crea tu cuenta en La Floristeria',
            'usuario' => $usuario, 
            'alertas' => $alertas
        ]);
    }
    ...
    public static function confirmar(Router $router) {
        ...
        $router->render('auth/confirmar', [
            'titulo' => 'Confirma tu cuenta la Floristeria',
            'alertas' => Usuario::getAlertas()
        ]);
    }
